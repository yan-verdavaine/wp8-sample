...
{
    public partial class PageMethod2 : PhoneApplicationPage
    {
        Method2Filter method = new Method2Filter();
        // Constructor
        public PageMethod2()
        {
            InitializeComponent();
                ...
                Deployment.Current.Dispatcher.BeginInvoke(() =>
                      {
                          ...
                          using (MediaLibrary mediaLibrary = new MediaLibrary())
                              mediaLibrary.SavePicture(String.Format("PictureNavigation Method2 {0:yyyyMMdd-HHmmss}", DateTime.Now), sout);
                      });
